...
document.querySelectorAll(".remove-product").forEach((buton)=>{
  buton.onclick=()=>{
    //! ekrandan sildik, remove dizinden silmiyor.
...
plus.onclick=()=>{
  ...
  //adet.textContent++   bir string olduğundan, JavaScript otomatik olarak bu değeri bir sayıya çevirir ve sonra artırma işlemi yapar.Bu otomatik dönüşüm bazen beklenmeyen sonuçlara yol açabilir.
  adet.textContent = Number(adet.textContent)+1 //daha açık ve güvenilir.


  //! ürünToplamin ekranda güncellenmesi
