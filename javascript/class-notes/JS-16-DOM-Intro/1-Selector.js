...
//*example2 paragraf style
   ...
   paragraf.color="red"
   paragraf.backgroundColor="yellow"
...
document.querySelector("title").textContent="DOM MANUPULATION ❤️"
...
console.log(parag); // NodeList getiriyor.
...
// baslik.namedItem("id1").style.color = "red"; bu cok önemli degil.
